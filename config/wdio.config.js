...
const urls = require('./urls.config.js');
const requires = require('./requires.config.js');
const suites = require('./suites.config.js');
...
const isPhantomJsBrowser = browser === 'phantomjs';
...
exports.config = {
    ...
    testDataFolderPath: 'src/files/testDataFiles',
    ...
    phantomjsOpts: !isPhantomJsBrowser ? null : {
        webdriverLogfile: './output/phantomjs.log',
        ignoreSslErrors: true
    },

    firefoxProfile: shouldNotLoadFirefoxProfile ? null : {
